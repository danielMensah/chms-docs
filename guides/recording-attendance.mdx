...
{/* Screenshot: manual check-in dialog with search field */}
...
{/* Screenshot: event QR code on the event detail page */}

{/* Screenshot: public check-in screen on a mobile device */}
...
{/* Screenshot: kiosk mode on a tablet */}
...
{/* Screenshot: bulk attendance entry with checkboxes and Select All toggle */}
...
{/* Screenshot: attendance list filtered by event */}
