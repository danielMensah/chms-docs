...
Organisation admins have visibility across the entire organisation. They can view branch records across all branches and manage supported branch records after selecting a branch. They can manage users, branches, custom fields, tags, and organisation-wide reports.
...
Editors can create and edit records within their branch, including members, events, locations, attendance, and visitors. They cannot delete records or manage users.

Assign this role to volunteers or staff who need to enter data but should not remove anything or invite other users.

### Treasurer

Treasurers are branch-scoped finance users. They can access **Gifting & Donations** and gifting reports for their assigned branch. They cannot access members, events, ministries, attendance, users, branch settings, or organisation settings.
