...
| --- | --- |
| **Member Directory** | List members with contact details, status, branch, age group, tags, and custom fields. |
| **Attendance Summary** | Review attendance records across events and services. |
| **Visitor Follow-up List** | Track visitors, tags, contact details, visit counts, and last visit dates. |
...
Filters vary by report type. Common filters include **Date Range**, **Lifecycle Status**, **Nationality**, **Branch**, **Event**, **Ministry**, **Member Name**, **Event Scope**, **Age Group**, **Tags**, and custom fields.

Member and visitor reports can include **Tags** as a selected column. When you filter by two or more tags, choose **Match any** to include people with at least one selected tag, or **Match all** to include only people with every selected tag.
